...
function Footer() {
  return (
    <footer className="mt-20 bg-ink text-stone py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="space-y-2">
            ...
            <a href="/" className="block text-stone/60 hover:text-white transition-colors">Home</a>
            <a href="/dashboard" className="block text-stone/60 hover:text-white transition-colors">Dashboard</a>
            <a href="/settings" className="block text-stone/60 hover:text-white transition-colors">Settings</a>
          </div>
          {/* Social */}
          <div className="space-y-2">
            <p className="font-semibold text-white mb-3">Connect</p>
            <div className="flex items-center gap-3 text-stone/60 hover:text-white transition-colors">
          ...
          <div className="space-y-2">
            ...
            <form id="subscribe-form" className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-md border border-stone/20 bg-ink/50 px-3 py-2 text-stone/80 placeholder-stone/30 focus:outline-none focus:ring-2 focus:ring-ochre"
                required
              />
              <button type="submit" className="bg-ochre hover:bg-ochre/90 text-paper px-4 py-2 rounded-md font-medium transition-all">
                Subscribe
              </button>
            </form>
